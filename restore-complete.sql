-- Restauração Completa: Localizações + Hotspots
-- Backup de 25/12/2025 15:25:08
-- Este script garante que todas as localizações existam antes de restaurar os hotspots

-- ========================================
-- PASSO 1: Garantir que todas as localizações necessárias existam
-- ========================================

-- Usar INSERT IGNORE para não sobrescrever localizações existentes
-- Só adiciona as que estão faltando

INSERT IGNORE INTO `locations` (`id`, `name`, `description`, `background_image`, `display_order`, `is_final_scene`) VALUES
('casa_abandonada_01_frente', 'Casa Abandonada...', 'Uma casa antiga', 'images/casa_abandonada_01_frente.jpg', 3, 0),
('casa_abandonada_01_porta_entrada', 'casa_abandonada_01_porta_entrada', 'Descrição do local...', 'images/casa_abandonada_01_porta_entrada.jpg', 6, 0),
('casa_abandonada_01_quarto', 'casa_abandonada_01_quarto', 'Descrição do local...', 'images/casa_abandonada_01_quarto.jpg', 7, 0),
('casa_abandonada_01_sala', 'casa_abandonada_01_sala', 'Descrição do local...', 'images/casa_abandonada_01_sala.jpg', 8, 0),
('casa_abandonada_02_cozinha', 'casa_abandonada_02_cozinha', 'Descrição do local...', 'images/casa_abandonada_02_cozinha.jpg', 4, 0),
('casa_abandonada_02_frente', 'casa_abandonada_02_frente', 'Descrição do local...', 'images/casa_abandonada_02_frente.jpg', 9, 0),
('casa_abandonada_02_porta_entrada', 'casa_abandonada_02_porta_entrada', 'Descrição do local...', 'images/casa_abandonada_02_porta_entrada.jpg', 10, 0),
('casa_abandonada_02_quintal', 'casa_abandonada_02_quintal', 'Descrição do local...', 'images/casa_abandonada_02_quintal.jpg', 11, 0),
('casa_abandonada_02_sala', 'casa_abandonada_02_sala', 'Descrição do local...', 'images/casa_abandonada_02_sala.jpg', 5, 0),
('cemiterio_dentro', 'cemiterio_dentro', 'Descrição do local...', 'images/cemiterio_dentro.jpg', 12, 0),
('cemiterio_entrada', 'cemiterio_entrada', 'Descrição do local...', 'images/cemiterio_entrada.jpg', 13, 0),
('cemiterio_mausoleo_dentro', 'cemiterio_mausoleo_dentro', 'Descrição do local...', 'images/cemiterio_mausoleo_dentro.jpg', 14, 0),
('cemiterio_mausoleo_frente', 'cemiterio_mausoleo_frente', 'Descrição do local...', 'images/cemiterio_mausoleo_frente.jpg', 15, 0),
('floresta', 'Floresta', 'Após caminhar por 1 hora, você encontra ao fundo um portão semi aberto.', 'images/floresta.jpg', 0, 0),
('igreja_dentro', 'igreja_dentro', 'Descrição do local...', 'images/igreja_dentro.jpg', 16, 0),
('igreja_frente', 'igreja_frente', 'Descrição do local...', 'images/igreja_frente.jpg', 17, 0),
('igreja_fundos', 'igreja_fundos', 'Descrição do local...', 'images/igreja_fundos_aberto.jpg', 18, 0),
('igreja_sinos', 'igreja_sinos', 'Descrição do local...', 'images/igreja_sinos.jpg', 19, 0),
('poco_profundo', 'Poço Profundo', 'Descrição do local...', 'images/poco_profundo.jpg', 20, 0),
('portao_entrada', 'Portao de entrada', 'Ao chegar mais perto dá pra ver que há uma trilha adentro', 'images/portao_entrada.jpg', 1, 0),
('portao_entrada_fechado', 'Portão de Entrada', 'Minha nossa, agora o portão está trancado, devo retornar, adentrar a vila e achar uma saída!', 'images/portao_entrada_fechado.jpg', 21, 0),
('portao_saida', 'portao_saida', 'Descrição do local...', 'images/portao_saida.jpg', 22, 0),
('portao_saida_aberto', 'portao_saida_aberto', 'Descrição do local...', 'images/portao_saida_aberto.jpg', 23, 0),
('portao_saida_cadeado', 'portao_saida_cadeado', 'Descrição do local...', 'images/portao_saida_cadeado.jpg', 24, 0),
('portao_saida_end', 'Portao de saída', 'Finalmente o portão é aberto, e consigo sair da vila abandonada, mas quando olho para trás! cuidado com a vila!', 'images/portao_saida_aberto_fim.jpg', 29, 1),
('praca_central', 'Praça Central', 'Descrição do local...', 'images/praca_central.jpg', 25, 0),
('rua_final', 'rua_final', 'Descrição do local...', 'images/rua_final.jpg', 26, 0),
('rua_vila', 'Rua da Vila', 'Incrível, após passar pelo portão e caminhar um pouco, chega em uma vila abandonada', 'images/rua_vila.jpg', 2, 0);

-- ========================================
-- PASSO 2: Limpar e restaurar HOTSPOTS
-- ========================================
...
-- ========================================
-- 28 localizações garantidas (INSERT IGNORE não sobrescreve existentes)
-- 80 hotspots restaurados com sucesso
